...
namespace EndpointGoogleMap
{
    public class FM_Click
    {
        ...
        GpioController enablePinController;
        GpioController resetPinController;
        int enablePin;
        int resetPin;
        /// <summary>Constructs a new instance.</summary>      
        public FM_Click(int reset, int en, int i2c)
        {
            ...
            resetPinController = new GpioController(PinNumberingScheme.Logical, new LibGpiodDriver(resetPin / 16));
            resetPinController.OpenPin(resetPin % 16);
            resetPinController.SetPinMode(resetPin % 16, PinMode.Output);

 
            enablePinController = new GpioController(PinNumberingScheme.Logical, new LibGpiodDriver(enablePin / 16));
            enablePinController.OpenPin(enablePin % 16);
            enablePinController.SetPinMode(enablePin % 16, PinMode.Output);

            enablePinController.Write(enablePin % 16, PinValue.High);

            //Wrapper:
            EPM815.I2c.Initialize(i2c);
            var i2cConnectionSetting = new I2cConnectionSettings(i2c, FM_Click.I2C_ADDRESS);
            this.i2cController = I2cDevice.Create(i2cConnectionSetting);


            this.InitializeDevice(resetPinController, resetPin % 16, i2cController);
        ...
        //    enablePinController.Write(enablePin % 16, PinValue.Low);
        //    enablePinController.ClosePin(enablePin % 16);
        //    enablePinController.Dispose();

        //    resetPinController.ClosePin(resetPin % 16);
        //    resetPinController.Dispose();

        //    this.i2cController.Dispose();
        //}
        //public void TurnOff()
        //{
        //    enablePinController.Write(enablePin % 16, PinValue.Low);
        ...
        private void InitializeDevice(GpioController resetPinController, int pinNumberReset, I2cDevice i2cController)
        {
            resetPinController.Write(pinNumberReset, PinValue.Low);
            Thread.Sleep(100);
            resetPinController.Write(pinNumberReset, PinValue.High);
            Thread.Sleep(10);
