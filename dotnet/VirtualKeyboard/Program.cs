    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var configuration = new FBDisplay.Configuration()
            {
                ...
                Clock = 24750,
                Width = SCREEN_WIDTH,
                Hsync_start = SCREEN_WIDTH + 54,
                Hsync_end = SCREEN_WIDTH + 54 + 2,
                Htotal = SCREEN_WIDTH + 54 + 2 + 44,
                Height = SCREEN_HEIGHT,
                Vsync_start = SCREEN_HEIGHT + 49,
                Vsync_end = SCREEN_HEIGHT + 49 + 2,
                Vtotal = SCREEN_HEIGHT + 49 + 2 + 22,
                Bus_flags = 68,
